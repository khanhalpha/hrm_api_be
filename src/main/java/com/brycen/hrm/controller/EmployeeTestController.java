...
public class EmployeeTestController {
    ...
    @GetMapping("/employees/filter")
    public Page<Employee> getAllEmployeesPage(@RequestParam(required = false, defaultValue = "") String fullname,
            @RequestParam(required = false, defaultValue = "0") Long skillId, @RequestParam(required = false, defaultValue = "0") Long departmentId,
        ...
        List<Employee> employees = q.setFirstResult(page * size).setMaxResults(size).getResultList();
